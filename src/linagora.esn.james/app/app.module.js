...
require ('./config-form/james-config-form.component.js');
require ('./config-form/james-config-form.controller.js');
...
require ('./quota/displayer/james-quota-displayer.component.js');
...
require ('./quota/form/james-quota-form.component.js');
require ('./quota/form/james-quota-form.controller.js');
